...
/**
 * @Description 단건삭제 Output
 */
@XmlType(propOrder={"succYn"}, name="SSMP1001A004OutDto")
...
public class SSMP1001A004OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1001A004OutDto other= (bxm.dft.smp.online.service.dto.SSMP1001A004OutDto)obj;
		if ( succYn == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1001A004OutDto:\n");
		sb.append("\tsuccYn: ");
