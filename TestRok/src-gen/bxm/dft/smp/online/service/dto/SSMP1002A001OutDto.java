...
/**
 * @Description 다건조회1 Output
 */
@XmlType(propOrder={"grid01_COUNT", "grid01_STARTLINE", "grid01"}, name="SSMP1002A001OutDto")
...
public class SSMP1002A001OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	* Property set << grid01 >> [[ */
	...
	private java.util.List<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01> grid01  = new java.util.ArrayList<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01>();
	
	/**
	 * 
	 * @Description grid01
	 */
	public java.util.List<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01>  getGrid01(){
		return grid01;
	}
	 ...
	 */
	@JsonProperty("grid01")
	public void setGrid01( java.util.List<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01> grid01 ) {
		isSet_grid01 = true;
		this.grid01 = grid01;
	}
	...
	*******************************************************************************************************************************/
	...
	public SSMP1002A001OutDto clone(){
		try{
			...
			if ( this.grid01== null ) object.grid01 = null;
				...
				java.util.List<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01> clonedList = new java.util.ArrayList<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01>(grid01.size());
				for( bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01 item : grid01 ){
					clonedList.add( (bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01)item.clone());
				}
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1002A001OutDto other= (bxm.dft.smp.online.service.dto.SSMP1002A001OutDto)obj;
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1002A001OutDto:\n");
	...
	public long predictMessageLength(){
		...
		{/*grid01*/
			...
			bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01 emptyElement= null;
			for ( int i = 0; i < size ; ++i ){
				if ( i < min ){
					bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01 element= grid01.get(i);
	...
	public void set(String key, Object value){
		...
		case 1411025086 : /* grid01_STARTLINE */
			...
			return;
		case -1237657657 : /* grid01 */
			setGrid01((java.util.List<bxm.dft.smp.online.service.dto.SSMP1002A001OutDtoSubGrid01>) value);
			return;
