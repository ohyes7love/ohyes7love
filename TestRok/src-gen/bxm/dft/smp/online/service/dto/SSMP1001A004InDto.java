...
/**
 * @Description 단건삭제 Input
 */
@XmlType(propOrder={"feduEmpNo"}, name="SSMP1001A004InDto")
...
public class SSMP1001A004InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1001A004InDto other= (bxm.dft.smp.online.service.dto.SSMP1001A004InDto)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1001A004InDto:\n");
		sb.append("\tfeduEmpNo: ");
