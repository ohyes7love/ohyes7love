 ...
 */
@XmlType(propOrder={"pageNum", "pageCount", "feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduIpsaDt", "feduPayAmt", "feduDeptNo"}, name="SSMP1003A002InDto")
...
public class SSMP1003A002InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	* Property set << pageNum >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="페이지넘버", formatType="", format="", align="right", length=5, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	...
	* Property set << pageCount >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="페이지카운트", formatType="", format="", align="right", length=5, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1003A002InDto other= (bxm.dft.smp.online.service.dto.SSMP1003A002InDto)obj;
		if ( pageNum == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1003A002InDto:\n");
		sb.append("\tpageNum: ");
