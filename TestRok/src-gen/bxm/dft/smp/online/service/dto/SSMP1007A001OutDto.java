...
/**
 * @Description 온디맨드배치호출 Output
 */
@XmlType(propOrder={"succYn"}, name="SSMP1007A001OutDto")
...
public class SSMP1007A001OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1007A001OutDto other= (bxm.dft.smp.online.service.dto.SSMP1007A001OutDto)obj;
		if ( succYn == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1007A001OutDto:\n");
		sb.append("\tsuccYn: ");
