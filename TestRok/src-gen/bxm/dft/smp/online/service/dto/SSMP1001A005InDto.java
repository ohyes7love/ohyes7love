 ...
 * @Description 
 */
@XmlType(propOrder={"feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduIpsaDt", "feduPayAmt", "feduDeptNo", "smpEmpTstRowData"}, name="SSMP1001A005InDto")
...
public class SSMP1001A005InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	/*******************************************************************************************************************************
	* Property set << smpEmpTstRowData >> [[ */
	
	@XmlTransient
	private boolean isSet_smpEmpTstRowData = false;
	
	protected boolean isSet_smpEmpTstRowData()
	{
		return this.isSet_smpEmpTstRowData;
	}
	
	protected void setIsSet_smpEmpTstRowData(boolean value)
	{
		this.isSet_smpEmpTstRowData = value;
	}
	
	
	@BxmOmm_Field(referenceType="reference", description="SMP_EMP_TST 조회 DTO", formatType="", format="", align="left", length=20, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto smpEmpTstRowData  = null;
	
	/**
	 * 
	 * @Description SMP_EMP_TST 조회 DTO
	 */
	@XmlElement(nillable=true)
	public bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto getSmpEmpTstRowData(){
		return smpEmpTstRowData;
	}
	...
	public void setSmpEmpTstRowData( bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto smpEmpTstRowData ) {
		isSet_smpEmpTstRowData = true;
	...
	*******************************************************************************************************************************/
	...
	public SSMP1001A005InDto clone(){
		try{
			...
			else object.smpEmpTstRowData = (bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto)this.smpEmpTstRowData.clone();
	...
	public int hashCode(){
		...
		result = prime * result + ((smpEmpTstRowData==null)?0:smpEmpTstRowData.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1001A005InDto other= (bxm.dft.smp.online.service.dto.SSMP1001A005InDto)obj;
		if ( feduEmpNo == null){
		...
		if ( feduDeptNo == null){
			...
			return false;
		if ( smpEmpTstRowData == null){
			if ( other.smpEmpTstRowData != null ) return false;
		}
		else if ( !smpEmpTstRowData.equals(other.smpEmpTstRowData) )
			return false;
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1001A005InDto:\n");
		sb.append("\tfeduEmpNo: ");
	...
	public long predictMessageLength(){
		...
		{
			bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto temp= smpEmpTstRowData;
			if ( temp== null ) temp= new bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto();
	...
	public java.util.List<String> getFieldNames(){
		...
		fieldNames.add("smpEmpTstRowData");
	...
	public java.util.Map<String, Object> getFieldValues(){
		...
		fieldValueMap.put("smpEmpTstRowData", get("smpEmpTstRowData"));
	...
	public void set(String key, Object value){
		...
		case 255783062 : /* feduDeptNo */
			...
			return;
		case -1498216895 : /* smpEmpTstRowData */
			setSmpEmpTstRowData((bxm.dft.smp.online.dbio.dto.DSmpEmpTst000Dto) value);
			return;
