 ...
 * @Description 
 */
@XmlType(propOrder={"size", "empList"}, name="SSMP1006A002InDto")
...
public class SSMP1006A002InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	* Property set << size >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="", formatType="", format="", align="right", length=9, decimal=0, arrayReference="", fill="", encrypt="", validationRule="BXMVD0008[1]")
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1006A002InDto other= (bxm.dft.smp.online.service.dto.SSMP1006A002InDto)obj;
		if ( size == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1006A002InDto:\n");
		sb.append("\tsize: ");
