...
/**
 * @Description 단건조회 Input
 */
@XmlType(propOrder={"feduEmpNo"}, name="SSMP1001A001InDto")
...
public class SSMP1001A001InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	* Property set << feduEmpNo >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="FW교육임직원번호", formatType="", format="", align="right", length=6, decimal=0, arrayReference="", fill="", encrypt="", validationRule="BXMVD0006[9999]")
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1001A001InDto other= (bxm.dft.smp.online.service.dto.SSMP1001A001InDto)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1001A001InDto:\n");
		sb.append("\tfeduEmpNo: ");
