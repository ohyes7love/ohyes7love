...
/**
 * @Description 다건조회2 Sub Ouput
 */
@XmlType(propOrder={"feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduIpsaDt", "feduPayAmt", "feduDeptNo"}, name="SSMP1002A002OutDtoSubGrid01")
...
public class SSMP1002A002OutDtoSubGrid01  implements IOmmObject, Predictable, FieldInfo  {
	...
	* Property set << feduOccpNm >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="FW교육직업명", formatType="", format="", align="left", length=9, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	...
	* Property set << feduMngrEmpNo >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="FW교육관리자임직원번호", formatType="", format="", align="right", length=4, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private java.lang.Integer feduMngrEmpNo  = 0;
	
	/**
	 * 
	 * @Description FW교육관리자임직원번호
	 */
	@XmlElement(nillable=true)
	...
	* Property set << feduIpsaDt >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="FW교육입사일자", formatType="", format="", align="left", length=8, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private java.lang.String feduIpsaDt  = null;
	
	/**
	 * 
	 * @Description FW교육입사일자
	 */
	@XmlElement(nillable=true)
	...
	* Property set << feduPayAmt >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="FW교육급여금액", formatType="", format="", align="right", length=19, decimal=2, arrayReference="", fill="", encrypt="", validationRule="")
	...
	* Property set << feduDeptNo >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="FW교육부서번호", formatType="", format="", align="right", length=2, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private java.lang.Integer feduDeptNo  = 0;
	
	/**
	 * 
	 * @Description FW교육부서번호
	 */
	@XmlElement(nillable=true)
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1002A002OutDtoSubGrid01 other= (bxm.dft.smp.online.service.dto.SSMP1002A002OutDtoSubGrid01)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1002A002OutDtoSubGrid01:\n");
		sb.append("\tfeduEmpNo: ");
