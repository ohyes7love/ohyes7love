 ...
 */
@XmlType(propOrder={"pageNum", "pageCount", "totalCount", "grid01_COUNT", "grid01_STARTLINE", "grid01"}, name="SSMP1003A002OutDto")
...
public class SSMP1003A002OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	/*******************************************************************************************************************************
	* Property set << pageNum >> [[ */
	
	@XmlTransient
	private boolean isSet_pageNum = false;
	
	protected boolean isSet_pageNum()
	{
		return this.isSet_pageNum;
	}
	
	protected void setIsSet_pageNum(boolean value)
	{
		this.isSet_pageNum = value;
	}
	
	
	@BxmOmm_Field(referenceType="reference", description="pageNum", formatType="", format="", align="right", length=5, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private java.lang.Integer pageNum  = 0;
	...
	*******************************************************************************************************************************/
	/*******************************************************************************************************************************
	* Property set << pageCount >> [[ */
	
	@XmlTransient
	private boolean isSet_pageCount = false;
	
	protected boolean isSet_pageCount()
	{
		return this.isSet_pageCount;
	}
	
	protected void setIsSet_pageCount(boolean value)
	{
		this.isSet_pageCount = value;
	}
	
	
	@BxmOmm_Field(referenceType="reference", description="pageCount", formatType="", format="", align="right", length=5, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private java.lang.Integer pageCount  = 0;
	...
	*******************************************************************************************************************************/
	/*******************************************************************************************************************************
	* Property set << totalCount >> [[ */
	
	@XmlTransient
	private boolean isSet_totalCount = false;
	
	protected boolean isSet_totalCount()
	{
		return this.isSet_totalCount;
	}
	
	protected void setIsSet_totalCount(boolean value)
	{
		this.isSet_totalCount = value;
	}
	
	
	@BxmOmm_Field(referenceType="reference", description="totalCount", formatType="", format="", align="right", length=8, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	private java.lang.Integer totalCount  = 0;
	...
	* Property set << grid01 >> [[ */
	...
	private java.util.List<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01> grid01  = new java.util.ArrayList<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01>();
	
	/**
	 * 
	 * @Description grid01
	 */
	public java.util.List<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01>  getGrid01(){
		return grid01;
	}
	 ...
	 */
	@JsonProperty("grid01")
	public void setGrid01( java.util.List<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01> grid01 ) {
		isSet_grid01 = true;
		this.grid01 = grid01;
	}
	...
	*******************************************************************************************************************************/
	...
	public SSMP1003A002OutDto clone(){
		try{
			...
			if ( this.grid01== null ) object.grid01 = null;
				...
				java.util.List<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01> clonedList = new java.util.ArrayList<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01>(grid01.size());
				for( bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01 item : grid01 ){
					clonedList.add( (bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01)item.clone());
				}
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1003A002OutDto other= (bxm.dft.smp.online.service.dto.SSMP1003A002OutDto)obj;
		if ( pageNum == null){
			...
			return false;
		if ( pageCount == null){
			if ( other.pageCount != null ) return false;
		}
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1003A002OutDto:\n");
		sb.append("\tpageNum: ");
	...
	public long predictMessageLength(){
		...
		{/*grid01*/
			...
			bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01 emptyElement= null;
			for ( int i = 0; i < size ; ++i ){
				if ( i < min ){
					bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01 element= grid01.get(i);
	...
	public java.util.Map<String, Object> getFieldValues(){
		...
		fieldValueMap.put("pageNum", get("pageNum"));
		fieldValueMap.put("pageCount", get("pageCount"));
		fieldValueMap.put("totalCount", get("totalCount"));
	...
	public void set(String key, Object value){
		...
		case 1411025086 : /* grid01_STARTLINE */
			...
			return;
		case -1237657657 : /* grid01 */
			setGrid01((java.util.List<bxm.dft.smp.online.service.dto.SSMP1003A002OutDtoSubGrid01>) value);
			return;
