...
/**
 * @Description 내부연동 Input
 */
@XmlType(propOrder={"feduEmpNo"}, name="SSMP1005A001InDto")
...
public class SSMP1005A001InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1005A001InDto other= (bxm.dft.smp.online.service.dto.SSMP1005A001InDto)obj;
		if ( feduEmpNo == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1005A001InDto:\n");
		sb.append("\tfeduEmpNo: ");
