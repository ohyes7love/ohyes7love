...
/**
 * @Description 책임자승인처리 Output
 */
@XmlType(propOrder={"succYn"}, name="SSMP1010A001OutDto")
...
public class SSMP1010A001OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1010A001OutDto other= (bxm.dft.smp.online.service.dto.SSMP1010A001OutDto)obj;
		if ( succYn == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1010A001OutDto:\n");
		sb.append("\tsuccYn: ");
