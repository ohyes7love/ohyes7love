...
/**
 * @Description 단건수정 Output
 */
@XmlType(propOrder={"succYn"}, name="SSMP1001A005OutDto")
...
public class SSMP1001A005OutDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1001A005OutDto other= (bxm.dft.smp.online.service.dto.SSMP1001A005OutDto)obj;
		if ( succYn == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1001A005OutDto:\n");
		sb.append("\tsuccYn: ");
