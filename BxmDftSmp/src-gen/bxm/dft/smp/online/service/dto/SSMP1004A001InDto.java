...
/**
 * @Description 다이나믹쿼리 Input
 */
@XmlType(propOrder={"gubun", "feduEmpNo", "feduEmpNm", "feduOccpNm", "feduMngrEmpNo", "feduIpsaDt", "feduPayAmt", "feduDeptNo"}, name="SSMP1004A001InDto")
...
public class SSMP1004A001InDto  implements IOmmObject, Predictable, FieldInfo  {
	...
	* Property set << gubun >> [[ */
	...
	@BxmOmm_Field(referenceType="reference", description="메소드구분", formatType="", format="", align="left", length=2, decimal=0, arrayReference="", fill="", encrypt="", validationRule="")
	...
	*******************************************************************************************************************************/
	...
	public boolean equals(Object obj) {
		...
		final bxm.dft.smp.online.service.dto.SSMP1004A001InDto other= (bxm.dft.smp.online.service.dto.SSMP1004A001InDto)obj;
		if ( gubun == null){
	...
	public String toString() {
		...
		sb.append( "\n[bxm.dft.smp.online.service.dto.SSMP1004A001InDto:\n");
		sb.append("\tgubun: ");
